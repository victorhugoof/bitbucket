...
public class ImageProcess {
	...
	public static void histograma(Image imagem, BarChart<String, Number> barChart, boolean acumulado,
			boolean separaCor) {
	...
	public static Image histogramaEqualizado(Image imagem, EnumTipoEqualizacao tipoEqualizacao) {
		var w = (int) imagem.getWidth();
		var h = (int) imagem.getHeight();
		var pr = imagem.getPixelReader();
		var wi = new WritableImage(w, h);
	...
	public static Image centralizaPixels(Image imagem, int tonsValidos) {
		var w = (int) imagem.getWidth();
		var h = (int) imagem.getHeight();
		var pr = imagem.getPixelReader();
		var wi = new WritableImage(w, h);
	...
	public static Image segmentacao(Image imagem, double limiarSegmentacao) {
		int w = (int) imagem.getWidth();
		int h = (int) imagem.getHeight();
	...
	public static WritableImage rotate90(Image imagem) {
	...
	public static WritableImage rotate180(Image imagem) {
		var wi = rotate90(imagem);
		return rotate90(wi);
	}

	public static void insereImagemSemEfeito(int w, int h, PixelReader pr, PixelWriter pw) {
		for (int i = 0; i < w; i++) {
			for (int j = 0; j < h; j++) {
